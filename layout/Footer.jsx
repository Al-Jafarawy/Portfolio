...
const Footer = () => {
  ...
  return (
    <footer
      className="relative overflow-hidden text-gray-700 dark:text-gray-300 transition-colors duration-300 
        ...
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-400 max-w-xs mx-auto md:mx-0">
              Portfolio showcasing projects, skills, and freelance experience in
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70">
          <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-xl max-w-md w-full transition-colors duration-300">
            ...
            <h3 className="mb-4 text-xl font-bold text-indigo-900 dark:text-white">
              Share Your Feedback
            </h3>
            <textarea
            ...
            />
            <button className="mt-4 w-full bg-indigo-600 hover:bg-indigo-700 dark:hover:bg-indigo-500 text-white py-2 rounded-lg transition">
              Submit
            </button>
          </div>
        </div>
